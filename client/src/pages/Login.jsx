      ...
      <div className="mt-[-10%] relative h-screen flex justify-center items-center">
        ...
        <div className="min-h-screen w-200 flex items-center justify-center font-serif mt-30">
          <div className="bg-white/10 backdrop-blur-xl p-10 rounded-2xl shadow-2xl w-full max-w-md border border-yellow-500">
            <h2 className="text-3xl text-center font-bold text-blue-500 mb-6 drop-shadow-md">
              Login
            </h2>
            <form className="space-y-5" onSubmit={formSubmitKro}>
              <div>
                ...
                <input
                  type="email"
                  className="w-full px-4 py-2 rounded-lg bg-white/20 text-black placeholder:text-gray-500 border border-yellow-400 focus:outline-none focus:ring-2 focus:ring-black-300"
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-400 to-blue-600 text-[#0f172a] font-semibold py-2 rounded-xl shadow-lg hover:scale-105 transition-transform duration-200"
              >
                Sign In
              </button>
            </form>
